...
class LoRa(object):
    ...
    def clear_irq_flag_RxDone(self):
        v = self.spi.xfer([REG.LORA.IRQ_FLAGS | 0x80, IRQ_FLAGS.RxDone])[1]
        return v
    
    def clear_irq_flag_TxDone(self):
        v = self.spi.xfer([REG.LORA.IRQ_FLAGS | 0x80, IRQ_FLAGS.TxDone])[1]
        return v
